...
import { ChevronDown, TrendingUp, BarChart3, Zap, Users } from 'lucide-react';
  ...
  const faqs = [
    {
      ...
      a: 'Du som driver selv og gjør manuelt arbeid. Du vil gjerne at en ekspert hjelper deg med prising, strategi og rapporter. Du ønsker ikke hands-on drift, bare veiledning.',
    },
    {
      q: 'Hva gjør dere konkret?',
      a: 'Vi analyserer markedet ditt, setter opp PriceLabs-strategi, gir deg månedsrapporter med innsikt, og diskuterer optimiseringspotensial. Du tar beslutningene. Vi gir råd.',
    },
    {
      q: 'Hvordan fungerer det praktisk?',
      a: 'Vi møtes én gang for å forstå eiendommen din. Deretter får du månedlig rapport og kan kontakte oss for spørsmål. Også mulig med telefonsamtaler annenhver uke hvis du ønsker det.',
    },
    {
    ...
    {
      q: 'Fungerer det for flere enheter?',
      a: 'Ja. Vi kan optimalisere portefølje av flere enheter. Jo flere, jo mer verdi får du fra strategi-fokus.',
    },
  ];
  ...
  const services = [
    {
      ...
      desc: 'Vi analyserer markedet ditt, konkurrenter og sesong. Vi setter opp PriceLabs og gir deg strategi for optimal prising.',
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      desc: 'Vi identifiserer hvor du kan tjene mer: prisstrategi-justeringer, sesong-fokus, eller produktforbedringer.',
    },
    {
      icon: Users,
      title: 'Konsultasjon',
      desc: 'Du kan kontakte oss når som helst. Telefonsamtaler annenhver uke eller på forespørsel. Vi diskuterer strategi, ikke praktisk drift.',
    },
  ];
          ...
          <div style={{
            ...
            {[
              ...
              },
              {
                step: '2',
                title: 'Analyse',
                desc: 'Vi analyserer markedet ditt, konkurrenter, prising og belegg. Vi setter opp PriceLabs-strategi.',
              },
              {
                step: '3',
                title: 'Månedsrapporter',
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Inkluderer månedsrapporter, prisanalyse, PriceLabs-setup og konsultasjon. Prisen kan variere avhengig av kompleksitet og antall enheter.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: 14, lineHeight: 1.8 }}>
              <strong>Fleksibilitet:</strong> Vi diskuterer nøyaktig hva du trenger. Hvis du vil telefonsamtaler annenhver uke i tillegg, eller flere enheter, justerer vi prisen etter det.
            </p>
          </div>
        </div>
      </section>
