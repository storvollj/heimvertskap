...
export default function PartnerSide() {
  ...
  const faqs = [
    ...
    {
      q: 'Hvem er dette for?',
      a: 'Investorer med 5-10+ enheter. Leirsteder. Flereenhetsbygg. Eller porteføljer som skal skaleres raskt. Du trenger ikke "Full Drift" for hver enhet — vi bygger et system som fungerer for alle.',
    },
    {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ lineHeight: 1.8, margin: 0, fontSize: 14, color: 'rgba(255,255,255,0.85)' }}>
                Du eier flere leiligheter i Tromsø. Vi setter opp sentralisert drift for alle, automatisert booking-flow, og rapportering. Du skalerer fra 5 til 10 enheter uten økt overhead.
              </p>
            </div>
