...
export default function OppsartSide() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Vi hjelper deg sette opp Airbnb og Booking-annonser, tar profesjonelle bilder (eller veileder deg), setter opp systemene, lager husregler, priser første opphold, og guider deg gjennom første gjester.',
    },
    {
    ...
    },
    {
      ...
      a: 'Vi introduserer deg til Airbnb, Booking.com, channel manager, og grunnleggende prising. Vi lærer deg systemene slik at du er komfortabel med dem.',
    },
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: 'Vi setter opp Airbnb og Booking.com-annonser, fotobrief, husregler, og channel manager-system. Du er med og lærer.',
    },
    {
      step: '3',
    ...
    },
    {
      ...
      desc: 'Efter 1-3 måneder har du rutiner, erfaring, og selvtillit. Du er klar til å drive selv — eller oppgradere til Full Drift.',
    },
  ];
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Typisk 3 måneder. Dekker alle møter og veiledning. Fleksibelt slutt når du er klar.
              </p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: 14, lineHeight: 1.8 }}>
              <strong>Velg det som passer deg best.</strong> Engangsgebyr hvis du vil rask start. Månedlig hvis du ønsker mer fleksibilitet og spredt kostnad.
            </p>
          </div>
        </div>
      </section>
